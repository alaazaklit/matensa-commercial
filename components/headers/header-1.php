...
<header class="header headerbig <?php if($pageName=="index"){?>white-header<?php } ?>">
<div class="container mod">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="navbar-toggler" onclick="showMenu()" type="button" data-target="#navbarNav"
                aria-controls="navbarNav" aria-label="Toggle navigation">
                <span class="menu-bar"><span></span><span></span><span></span></span>
            </a>

            <span class="menu-mobile-shadow"></span>
            <div class="collapse navbar-collapse show ml-auto" id="navbarNav">
...
<header class="header headersmall <?php if($pageName=="index"){?>white-header<?php } ?>">
    <div class="container mod">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index">
                <?php if($pageName=="index"){?><img src="assets/images/white-logo.svg" alt="Logo"
            ...
            <div class="collapse navbar-collapse show ml-auto" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li
                        class="nav-item dropdown nodown <?php if($pageName=="growbusiness" || $pageName=="agreementoverview" || $pageName=="transactionhistory" || $pageName=="businessintegration"){?>active<?php } ?>">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Matensa for Business
                        </a>
                        <div class="dropdown-menu" >
                            ...
                            <!-- <div class="dropdown-divider"></div> -->
                            <a class="dropdown-item" href="transactionhistory">Transaction History</a>
                            <a class="dropdown-item" href="businessintegration">Seamless Integration</a>
                    ...
                    <li
                        ...
                        <div class="dropdown-menu" >
                            <a class="dropdown-item" href="growbusiness">Refine Presence</a>
                            <a class="dropdown-item" href="agreementoverview">Secure Agreements</a>
                            <!-- <div class="dropdown-divider"></div> -->
                            <a class="dropdown-item" href="transactionhistory">Cash out</a>
                            <a class="dropdown-item" href="businessintegration">Top up</a>
                            <a class="dropdown-item" href="businessintegration">Check Transactions</a>
                        </div>
                    </li>
                    ...
                    <li
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Company <img src="assets/images/content/Vector (2).svg">
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="aboutus">About</a>
                            <a class="dropdown-item" href="jointeam">Careers</a>
                            <!-- <div class="dropdown-divider"></div> -->
                    ...
                    <li
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Support <img src="assets/images/content/Vector (2).svg">
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" >Help Center</a>
                            <a class="dropdown-item" href="reportbug">Report a Bug</a>
                            <!-- <div class="dropdown-divider"></div> -->
                        </div>
                    </li>
                    <li class="nav-item nav-item-btn">
                    <a class="nav-link btn-style-3 mr-2" href="https://dashboard.matensa.com/#/auth/login">
                            <i>
                            </i>
                            Log in
                             </a>
