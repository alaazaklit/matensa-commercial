...
<div>
    ...
    <div class="securepayment pb-5">
        <div class="container text-center pt-5 pb-5">
            ...
            <div class="heading-2  mb-4">Featured
                <span class="heading-3">Jobs </span>
            </div>

            <div class="block-slider slider-2 mb-5 pt-5">
                <div class="block-3">
            ...
            <button class="button-1">View More</button>
        </div>
    </div>
    ...
    <div class="journey mt-5 pb-5">
        ...
        <img class="image-4" src="assets/images/Glow (3).png">
        <img class="image-5" src="assets/images/Glow (1).png">
    </div>
</div>
